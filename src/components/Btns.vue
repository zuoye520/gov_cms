<template>
	<div>
		<section class="btns-cont">
			<ul>
				<li>
					<a v-link="{ name: 'complaint', query: { category: 13 }}" class="praise fn-clear">
				...
				<li>
					<a v-link="{ name: 'complaint', query: { category: 14 }}" class="complain fn-clear">
						<div class="fn-left aa">
							<p>诚信投诉</p>
							<p class="eg">ChengXinTouSu</p>
						</div>
						<div class="icon icon-complain"></div>
					</a>
				</li>
				<li>
					<a v-link="{ name: 'newsList', query: { category: 12 }}" class="download fn-clear">
						<div class="fn-left aa">
							<p>文件下载</p>
							<p class="eg">WenJianXiazai</p>
						</div>
